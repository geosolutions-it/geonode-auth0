...
SOCIAL_AUTH_AUTH0_DOMAIN = 'demos-sdf.eu.geonode_auth0.com'
SOCIAL_AUTH_STORAGE = 'geosk.geonode_auth0.models.Auth0DjangoStorage'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'geosk.geonode_auth0.pipelines.user_permissions'
)
